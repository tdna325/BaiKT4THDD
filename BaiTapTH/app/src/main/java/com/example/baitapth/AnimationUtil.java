...
public class AnimationUtil {
    ...
    public static  void translateAnimation(final ImageView viewAnimation, final View startView, View endView, final Animation.AnimationListener animationListener) {
        ...
        float  endViewWidthCenter = startView.getWidth()*0.75f;
        ...
        ScaleAnimation startScaleAnmition = new ScaleAnimation(1.0f,1.5f,1.0f,1.5f,startViewWidthCenter,startViewHeightCenter);
        startScaleAnmition.setDuration(animationDurution);
        ...
        animationSet.addAnimation(startScaleAnmition);
